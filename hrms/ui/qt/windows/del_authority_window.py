...
import pandas as pd
import os
DATA_PATH = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), '..', '..', 'data', 'DEL_AUTHORITY.csv')
class DelAuthorityWindow(QDialog):
    def __init__(self, parent=None):
        super().__init__(parent)
        self.setWindowTitle("刪除權限（DEL_AUTHORITY）管理")
        self.resize(600, 400)
        form = QFormLayout()
